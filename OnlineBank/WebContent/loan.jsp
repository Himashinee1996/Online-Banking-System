				...
				<div class="col">
					<div class="home_content">
						<div class="home_content_inner">
							<div class="home_title">Loan Details</div>
									...
									<ul class="main_menu_list">
										<li class="active hassubs">
											...
											<ul>
												...
												<li><a href="financial.jsp">Financial
			...
			<div class="row">
				<div class="col-lg-8 contact_form_col">
					<div class="section_title_container">
						...
						<div class="section_title">Loan Details</div>
					</div>
					<div class="contact_form_container">
						<form action="AddLoanServlet" class="contact_form">
							<div class="row">
								<div class="col-md-6">
									<input type="text" class="input_item" placeholder="Loan ID">
								</div>
								<div class="col-md-6">
									<input type="text" class="input_item" placeholder="LoanType">
								</div>
								<div class="col-md-6">
									<input type="number" class="input_item" placeholder="LoanAmount">
								</div>
								<div class="col-md-6">
									<input type="number" class="input_item" placeholder="Intrest">
								</div>
								<div class="col-md-6">
									<input type="number" class="input_item" placeholder="TotalLoan">
								</div>
								<div class="col-md-6">
									<input type="date" class="input_item" placeholder="LoanStart">
								</div>
								<div class="col-md-6">
									<input type="date" class="input_item" placeholder="LoanEnd">
								</div>
								<div class="col-md-12">
