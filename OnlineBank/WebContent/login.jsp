			...
			<div class="row">
				<div class="col-lg-8 contact_form_col">
					<div class="section_title_container">
						...
						<div class="section_title">Login Details</div>
					</div>
					<div class="contact_form_container">
						<form action="LoginServlet" class="contact_form">
							<div class="row">
								<div class="col-md-6">
								...
								<div class="col-md-12">
									<button id="contact_btn" type="submit" class="contact_button trans_200" value="Submit"><a href="index.jsp">Login</a></button>
								</div>
							</div>
						</form>
					</div>
