				...
				<div class="col">
					<div class="home_content">
						<div class="home_content_inner">
							<div class="home_title">CreditCard Details</div>
							<div class="home_breadcrumbs">
								<ul>
									<li><a href="index.jsp">Home</a></li>
									<li>CreditCard Details</li>
								</ul>
							</div>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-lg-8 contact_form_col">
					<div class="section_title_container">
						...
						<div class="section_title">CreditCard Details</div>
					</div>
					<div class="contact_form_container">
						<form action="AddCreditcardServlet" class="contact_form">
							<div class="row">
								<div class="col-md-6">
									<input type="text" class="input_item" placeholder="Card ID">
								</div>
								<div class="col-md-6">
									<input type="number" class="input_item" placeholder="Account No">
								</div>
								<div class="col-md-6">
									<input type="text" class="input_item" placeholder="Username">
								</div>
								<div class="col-md-6">
									<input type="number" class="input_item" placeholder="CardNo">
								</div>
								<div class="col-md-6">
									<input type="number" class="input_item" placeholder="CVV">
								</div>
								<div class="col-md-12">
			...
			<div class="row">
				...
				<div class="col-lg-6 footer_col">
					<div class="footer_newsletter">
						...
						<form action="contact.jsp" class="footer_newsletter_form">
