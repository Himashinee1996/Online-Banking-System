				...
				<ul class="menu_list">
					...
					<li class="menu_item">
						<div class="container">
							<div class="row">
								<div class="col">
									<a href="listings.jsp">services</a>
								</div>
							</div>
						</div>
					</li>
			...
			<div class="row">
				<div class="col-lg-8 contact_form_col">
					<div class="section_title_container">
						...
						<div class="section_title">Register Details</div>
					</div>
					<div class="contact_form_container">
						<form action="AddAdminServlet" class="contact_form">
							<div class="row">
								<div class="col-md-6">
									<input type="text" class="input_item" placeholder="StaffID">
								</div>
								<div class="col-md-6">
									<input type="text" class="input_item" placeholder="Username">
								</div>
								<div class="col-md-6">
									<input type="password" class="input_item" placeholder="Password">
								</div>
								<div class="col-md-12">
									<button id="contact_btn" type="submit" class="contact_button trans_200" value="Submit"><a href="login.jsp">Register</a></button>
								</div>
							</div>
						</form>
					</div>
