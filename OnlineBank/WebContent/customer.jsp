				...
				<div class="col">
					<div class="home_content">
						<div class="home_content_inner">
							<div class="home_title">Customer Details</div>
						...
						<div class="col">
							<div class="top_bar_container d-flex flex-row align-items-center justify-content-start">
								<div class="logo_container">
									<div class="logo">
										<a href="index.jsp">
										<div class="logo_line_1"><span>ONLINE</span>BANKING</div>
									<div class="logo_line_2">system</div>
								...
								<div class="main_menu_content">
									<ul class="main_menu_list">
										<li class="active hassubs">
											...
											<ul>
												<li><a href="index.jsp">Blockchain
										...
										<li class="hassubs">
											...
											<ul>
												<li><a href="creditcard.jsp">CreditCard
												...
												<li><a href="customer.jsp">Customer Details
												...
												<li><a href="loan.jsp">Loan Details
			...
			<div class="row">
				<div class="col-lg-8 contact_form_col">
					<div class="section_title_container">
						<div class="section_subtitle">Enter the </div>
						<div class="section_title">Customer Details</div>
					</div>
					<div class="contact_form_container">
						<form action="AddCustomerServlet" class="contact_form">
							<div class="row">
								<div class="col-md-6">
									<input type="text" class="input_item" placeholder="Customer ID">
								</div>
								<div class="col-md-6">
									<input type="text" class="input_item" placeholder="Fullname">
								</div>
								<div class="col-md-6">
									<input type="text" class="input_item" placeholder="Address">
								</div>
								<div class="col-md-6">
									<input type="text" class="input_item" placeholder="Country">
								</div>
								<div class="col-md-6">
									<input type="text" class="input_item" placeholder="NIC">
								</div>
								<div class="col-md-6">
									<input type="number" class="input_item" placeholder="ContactNo">
								</div>
								<div class="col-md-6">
									<input type="email" class="input_item" placeholder="Email">
								</div>
								<div class="col-md-6">
									<input type="number" class="input_item" placeholder="AccountNo">
								</div>
								<div class="col-md-6">
									<input type="number" class="input_item" placeholder="Balance">
								</div>
								<div class="col-md-12">
									<button id="contact_btn" type="submit" class="contact_button trans_200" value="Submit">submit</button>
								</div>
								<div class="col-md-12">
									<button id="contact_btn" type="submit" class="contact_button trans_200" value="Submit">update</button>
								</div>
								<div class="col-md-12">
									<button id="contact_btn" type="submit" class="contact_button trans_200" value="Submit">delete</button>
								</div>
							</div>
						</form>
					</div>
			...
			<div class="row">
				...
				<div class="col-lg-6 footer_col">
					<div class="footer_newsletter">
						...
						<form action="index.jsp" class="footer_newsletter_form">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Online Banking</a>
